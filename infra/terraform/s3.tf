...
resource "aws_s3_bucket" "ingest" { bucket = "${var.project}-ingest" tags = local.tags }
...
resource "aws_s3_bucket" "out" { bucket = "${var.project}-out" object_lock_enabled = true tags = local.tags }
...
resource "aws_s3_bucket" "vault" { bucket = "${var.project}-vault" object_lock_enabled = true tags = local.tags }
...
resource "aws_s3_bucket" "logs" { bucket = "${var.project}-logs" object_lock_enabled = true tags = local.tags }
...
resource "aws_s3_bucket_policy" "ingest_tls" { bucket = aws_s3_bucket.ingest.id policy = local.tls_only_policy }
resource "aws_s3_bucket_policy" "out_tls"    { bucket = aws_s3_bucket.out.id    policy = local.tls_only_policy }
resource "aws_s3_bucket_policy" "vault_tls"  { bucket = aws_s3_bucket.vault.id  policy = local.tls_only_policy }
resource "aws_s3_bucket_policy" "logs_tls"   { bucket = aws_s3_bucket.logs.id   policy = local.tls_only_policy }
